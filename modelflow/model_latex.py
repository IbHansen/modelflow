...
#print(drives)    
#os.path.exists(r'P:\ECB business areas\DGMF\STM\TOOLS\Satellite Model Tools\STAR_dev')
input=r'''\begin{dmath}
{PD\_IRB\_SE\_CC_{t}}={constant\_SE\_CC}+{parPD1\_IRB\_SE\_CC}\, {PD\_IRB\_SE\_CC_{t-1}}+{parPD2\_IRB\_SE\_CC}\, {PD\_IRB\_SE\_CC_{t-2}}+{pardifflogYER\_SE\_CC}\, diff\left(\log\left({YER\_CC_{t}}\right)\right)+{pardifflogYER1\_SE\_CC}\, diff\left(\log\left({YER\_CC_{t-1}}\right)\right)+{pardifflogYER2\_SE\_CC}\, diff\left(\log\left({YER\_CC_{t-2}}\right)\right)+diff\left(\log\left({YER\_CC_{t}}\right)\right)\, {pardifflogYERcons\_SE\_CC}\, 0.6+0.6\, diff\left(\log\left({YER\_CC_{t-1}}\right)\right)\, {pardifflogYER1cons\_SE\_CC}+0.6\, diff\left(\log\left({YER\_CC_{t-2}}\right)\right)\, {pardifflogYER2cons\_SE\_CC}+2\, diff\left(\log\left({YER\_CC_{t}}\right)\right)\, {pardifflogYERinv\_SE\_CC}+2\, diff\left(\log\left({YER\_CC_{t-1}}\right)\right)\, {pardifflogYER1inv\_SE\_CC}+2\, diff\left(\log\left({YER\_CC_{t-2}}\right)\right)\, {pardifflogYER2inv\_SE\_CC}+diff\left(\log\left({YER\_CC_{t}}\right)\right)\, {pardifflogYERext\_SE\_CC}\, 0.9+0.9\, diff\left(\log\left({YER\_CC_{t-1}}\right)\right)\, {pardifflogYER1ext\_SE\_CC}+0.9\, diff\left(\log\left({YER\_CC_{t-2}}\right)\right)\, {pardifflogYER2ext\_SE\_CC}+{pardifflogESX\_SE\_CC}\, diff\left(\log\left({ESX\_CC_{t}}\right)\right)+{pardifflogESX1\_SE\_CC}\, diff\left(\log\left({ESX\_CC_{t-1}}\right)\right)+{pardifflogESX2\_SE\_CC}\, diff\left(\log\left({ESX\_CC_{t-2}}\right)\right)+{parURX\_SE\_CC}\, {URX\_CC_{t}}+{parURX1\_SE\_CC}\, {URX\_CC_{t-1}}+{parURX2\_SE\_CC}\, {URX\_CC_{t-2}}+{pardiffURX\_SE\_CC}\, diff\left({URX\_CC_{t}}\right)+{pardiffURX1\_SE\_CC}\, diff\left({URX\_CC_{t-1}}\right)+{pardiffURX2\_SE\_CC}\, diff\left({URX\_CC_{t-2}}\right)+{pardifflogSA\_HIC\_SE\_CC}\, diff\left(\log\left({SA\_HIC\_CC_{t}}\right)\right)+{pardifflogSA\_HIC1\_SE\_CC}\, diff\left(\log\left({SA\_HIC\_CC_{t-1}}\right)\right)+{pardifflogSA\_HIC2\_SE\_CC}\, diff\left(\log\left({SA\_HIC\_CC_{t-2}}\right)\right)+{pardifflogSA\_IHX\_SE\_CC}\, diff\left(\log\left({SA\_IHX\_CC_{t}}\right)\right)+{pardifflogSA\_IHX1\_SE\_CC}\, diff\left(\log\left({SA\_IHX\_CC_{t-1}}\right)\right)+{pardifflogSA\_IHX2\_SE\_CC}\, diff\left(\log\left({SA\_IHX\_CC_{t-2}}\right)\right)+{parLTN\_SE\_CC}\, {LTN\_CC_{t}}+{parLTN1\_SE\_CC}\, {LTN\_CC_{t-1}}+{parLTN2\_SE\_CC}\, {LTN\_CC_{t-2}}+{pardiffLTN\_SE\_CC}\, diff\left({LTN\_CC_{t}}\right)+{pardiffLTN1\_SE\_CC}\, diff\left({LTN\_CC_{t-1}}\right)+{pardiffLTN2\_SE\_CC}\, diff\left({LTN\_CC_{t-2}}\right)+{parLTNDE\_\_LTN\_SE\_CC}\, \left({LTN\_CC_{t}}-{LTN\_DE_{t}}\right)+{parLTNDE1\_\_LTN1\_SE\_CC}\, \left({LTN\_CC_{t-1}}-{LTN\_DE_{t-1}}\right)+{parLTNDE2\_\_LTN2\_SE\_CC}\, \left({LTN\_CC_{t-2}}-{LTN\_DE_{t-2}}\right)+{parSTN\_SE\_CC}\, {STN\_CC_{t}}+{parSTN1\_SE\_CC}\, {STN\_CC_{t-1}}+{parSTN2\_SE\_CC}\, {STN\_CC_{t-2}}+{pardiffSTN\_SE\_CC}\, diff\left({STN\_CC_{t}}\right)+{pardiffSTN1\_SE\_CC}\, diff\left({STN\_CC_{t-1}}\right)+{pardiffSTN2\_SE\_CC}\, diff\left({STN\_CC_{t-2}}\right)+{eps\_IRB\_SE\_CC_{t}}
\end{dmath}'''
